...
-- kuvab tabeli enne ja pärast konkreetse kirje kustutamiskäsu täitmist
select * from Person
go
...
-- valib * kõikidest isikutest, kelle nimi ei alga tähega W, A või S
...
-- valib summa(kasti vanus tervikarvuks) kõigist isikutest
...
-- salvestatud protseduur arvutab ja tagastab kõigi töötajate koguarvu
