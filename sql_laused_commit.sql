...
--- andmete Female ja Male  sisestamine tabelisse 
insert into Gender (Id, Gender)
values (1, 'Female')
insert into Gender (Id, Gender)
values (2, 'Male')

--- välise võtme(foreign key) lisamine
alter table Person add constraint tblPerson_GenderId_FK
foreign key (GenderId) references Gender(Id)

-- sisestame andmed tabelisse Person
...
-- vaatame tabeli Person andmeid
select * from Person

--- võõrvõtme piirangu  maha võtmine / eemaldame välise võtme piirangu
alter table Person
drop constraint tblPerson_GenderId_FK

-- sisestame väärtuse tabelisse Gender 
insert into Gender (Id, Gender)
values (3, 'Unknown')
-- lisame võõrvõtme uuesti / välise võtme lisamine uue järgi
alter table Person
...
--tabeli Person piirangu lisamine
alter table Person
...
--kustutab kirje tabelist, kus ID=8
select * from Person
go
...
--Person tabeli kirjete valik ja nende järjestamine vanuse järgi
select * from Person order by cast(Age as int)
select * from Person order by Age

--arvutame Age veeru väärtuste summa
...
---ei aktsepteeri sisendparameetreid, kuid sellel on INT-tüüpi väljundparameeter "@TotalCount".
...
--- võtab sisendparameetri "@Id" tüüpi INT
...
--saab 6 ID-ga töötaja nime 
declare @FirstName nvarchar(50)
execute spGetNameById1 6, @FirstName output
print 'Name of the employee = ' + @FirstName

--võtab sisendparameetri  "@Id" 
...
-- kuulutab muutuja ja kutsub salvestatud protseduuri, et saada töötaja nimi ID-ga 1
