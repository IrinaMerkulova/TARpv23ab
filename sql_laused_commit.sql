...
---See päring lisab piirangu (check constraint) 
alter table Person
...
-- toome välja kõik, kes ei ela Gothamis
select * from Person where City <> 'Gotham'
select * from Person where City != 'Gotham'
...
-- näitab, kelle on emailis ees ja peale @-märki ainult üks täht
...
--? sorteerib inimesi vanuse järgi
