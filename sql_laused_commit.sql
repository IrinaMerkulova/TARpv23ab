...
--Näitab tabelit pärast kustutamist Id=8
select * from Person
go
...
--valib kõik read tabelist "Person", 
--kus veeru "Name" väärtus ei alga tähtedega "W", "A" või "S". 
--Näitab ridu, kus nimed ei alga nende tähtedega.
select * from Person where Name like '[^WAS]%'
--- teostab andmete filtreerimise "Person" tabelist ja valib kõik read, kus veeru 
--"City" väärtus on võrdne "Gotham" või "New York" 
...
--Need mõlemad päringud täidavad andmete sortimise tabelis "Person" vanuse järgi.
...
--Protseduuri loomine, et saada töötajate arv soo järgi
...
--- Protseduuri loomine Id-i töötajate nime saamiseks
