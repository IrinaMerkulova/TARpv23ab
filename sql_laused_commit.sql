...
--- tabelise Gender oli lisatud andmet 
...
--näitab, kelle nimi ei algab tähtedega "W" "A" "S"
select * from Person where Name like '[^WAS]%'
--- näitab, kes elab Gothamis või New Yorkis ja kes on vanem 40 aasta
...
-- korrastab neid vanuse järgi
select * from Person order by cast(Age as int)
select * from Person order by Age

--näitab veeru age väärtuste summat
...
--sisestab andmed tabelise Departament ja Employees
...
--arvutab valitud genderi töötajate arvu
...
---protsedur näitab, mittu töötajate on  
...
--- näitab töötaja nimi kellel on valitud id
