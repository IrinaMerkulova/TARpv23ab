...
--- päring lisab Personi tabelisse välise võtme nimega 
...
--CHECK piirangu lisamine ja lisab andmed
	alter table Person
...
--Tüüpide järjestamine ja sorteerib vana jargi 
select * from Person order by cast(Age as int)
select * from Person order by Age

--SQL päring arvutab See päring arvutab Personi tabeli Age veeru vanuse, teisendades need eelnevalt täisarvudeks.
...
--Employees tabelile veergude MiddleName ja LastName lisamine
alter table Employees
...
--Andmete värskendamine Employees'i tabelis
...
--- Loob protseduuri, mis tagastab töötajate nimed, soo ja ID tabelist Employees, mis rahuldab edastatud väärtusi @Gender ja @DepartmentId.
...
--See päring loob protseduuri, mis loeb teatud soost töötajate arvu (@Gender) Employees tabelis. Tulemus asetatakse muutujasse @EmployeeCount, mis kuulutatakse väljundparameetriks.
