...
print @TotalCount
-- Küsige naiste arvu saamiseks ja kuvage olenevalt tulemusest sobiv teade.
...
-- Taotlege töötaja nime saamiseks tema isikutunnistust.

--?
declare @FirstName nvarchar(50)
execute spGetNameById1 6, @FirstName output
print 'Name of the employee = ' + @FirstName
-- Päring töötaja nime saamiseks ID järgi ja selle kuvamiseks.
...
-- Taotlus saada töötaja nimi tema tunnuse järgi.
	
-- ?
declare @EmployeeName nvarchar(50)
exec @EmployeeName = spGetNameById2 1
print 'Name of the employee = ' + @EmployeeName
-- Taotlege töötaja nime saamist tema ID-ga ja kuvage see.
