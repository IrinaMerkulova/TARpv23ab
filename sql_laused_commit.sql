...
-- kirje kustutamine, kus aidi võrdub kaheksaga
select * from Person
go
...
-- valib kõigi väljadega kirjed ja sorteerib need väljal "age"
select * from Person order by cast(Age as int)
select * from Person order by Age

-- näitab igas vanuses summa tabelist person
...
--- valib Salary väljal kõige minimaalsema väärtusega kirje
...
-- lisab tabelisse välja MiddleName, millel on tüüp "nvarchar (30) "
alter table Employees
...
-- loob protseduuri , mis näitab töötajate arvu soo järgi ,
...
--- loob protseduuri, mis näitab töötajate arvu
...
-- loob tüüpmuutuja "EmployeeName" ja kasutab spGetNameById2 protseduuri, edastades sinna argumendi "1".
