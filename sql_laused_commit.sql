...
-- näitab kes elab Gothamis või New Yorkis ja vanus on suurem kui 40 
...
-- inimeste sorteerimine vanuse järgi
...
-- lisame tabelisse Department andmed
...
--- loome protseduur, mida kutsutakse id järgi
...
-- teeb protseduuri mis saab nime ID järgi
